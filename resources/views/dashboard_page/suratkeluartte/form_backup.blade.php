...
@section('title', 'Form '.ucwords($mode).' Surat Keluar dengan Tanda Tangan Elektronik')
@push('vendor-css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{'Form '.ucwords($mode).' Surat Keluar dengan Tanda Tangan Elektronik'}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{route('surat-keluar-tte')}}">Daftar Surat Keluar TTE</a></div>
                <div
                    class="breadcrumb-item active">{{'Form '.ucwords($mode).' Surat Keluar TTE'}}</div>
            </div>
        </div>
        <div class="section-body">
            ...
            @endif
            <form id="form" name="form" role="form" onsubmit="getbounds()" action="{{$action}}"
                ...
                <div class="card">
                    ...
                    <div class="col-sm-12 @if($status_sk =='final') d-none @endif">
