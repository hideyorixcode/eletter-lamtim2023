...
@section('title', 'Form Tanda Tangan Surat Keluar ')
@push('vendor-css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{'Tanda Tangan Surat Keluar Menggunakan Elektronik'}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{route('surat-keluar')}}">Daftar Surat Keluar TTE </a></div>
                <div class="breadcrumb-item active">{{'Tanda Tangan'}}</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="form" name="form" role="form" action="{{$action}}"
                                ...
                                <button type="submit" class="btn btn-primary">Tanda Tangan Surat</button>
                            </form>
                        </div>
                    </div>
                </div>
