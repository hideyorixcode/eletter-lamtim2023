...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Dashboard Sespri / Penandatangan</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="javascript:void(0)">Dashboard Sespri / Penandatangan</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-lg-3 col-form-label">Instansi</label>
                                        <div class="col-sm-6 col-lg-6">
                                           <input type="hidden" readonly value="{{Auth::user()->id_opd_fk}}" name="select_perangkat" id="select_perangkat">
                                           <input type="text" class="form-control" readonly value="{{$nama_opd}}" name="nama_perangkat" id="nama_perangkat">
                                        </div>
                ...
                data:
                    {
                        ...
                        namaperangkat: $("#nama_perangkat").val(),
                    },
