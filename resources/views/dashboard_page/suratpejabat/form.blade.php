...
@section('title', 'Form '.ucwords($mode).' Surat Masuk Pejabat')
@push('vendor-css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{'Form '.ucwords($mode).' Surat Masuk Intern'}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{route('surat-masuk-pejabat')}}">Daftar Surat Masuk</a></div>
                <div class="breadcrumb-item active">{{'Form '.ucwords($mode).' Surat Masuk Pejabat'}}</div>
            </div>
        </div>
                                        ...
                                        <div class="col-sm-9 col-lg-9">
                                            ...
                                            @else
                                                <input type="text" readonly
                                                       ...
                                                       value="{{cek_opd($kepada)->nama_opd}}">
                                                <input type="hidden" readonly class="form-control" name="kepada"
                                                       id="kepada" value="{{$kepada}}">
                                            @endif
                                            @error('kepada')
                                            <div class="invalid-feedback">
                                                {{$message}}
