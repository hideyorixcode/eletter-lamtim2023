...
@section('title', 'Form '.ucwords($mode).' Surat Rahasia ')
@push('vendor-css')
...
<section class="section">
   <div class="section-header">
      <h1>{{'Form '.ucwords($mode).' Surat Rahasia '}}</h1>
      <div class="section-header-breadcrumb">
         <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
         <div class="breadcrumb-item"><a href="{{route('surat-rahasia')}}">Daftar Surat Rahasia</a></div>
         <div class="breadcrumb-item active">{{'Form '.ucwords($mode).' Surat Rahasia '}}</div>
      </div>
   </div>
