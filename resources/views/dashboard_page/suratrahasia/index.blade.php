...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Daftar Surat Rahasia</h1>
            @if(in_array(Auth::user()->level, ['superadmin', 'admin', 'umum']))
                <div class="section-header-button">
                    <a href="{{ route('surat-rahasia.form') }}"
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Daftar Surat Rahasia</div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        Surat yang bersifat rahasia adalah surat yang diperuntukkan khusus untuk dibaca
                                        oleh tujuan
                                        surat. Surat tersebut langsung diserahkan ke Tujuan surat. Surat rahasia tidak
                                        bisa dibuka
                                        sehingga Hal surat rahasia tidak diketahui.
                                    </div>
                                </div>
                                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        @if(in_array(Auth::user()->level, ['umum', 'admin', 'superadmin']))
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteData(paramId) {
            var url = '{{ url('dashboard/surat-rahasia/delete/') }}';
            deleteDataTable(paramId, url);
        }

        function bulkDelete() {
            var url = '{{ url('dashboard/surat-rahasia/bulkDelete/') }}';
            bulkDeleteTable(url);
        }
