...
@section('title', 'Disposisi Surat '.ucwords($sifat_surat))
@push('vendor-css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{'Form Disposisi Surat '.ucwords($sifat_surat)}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{route('surat-masuk')}}">Disposisi</a></div>
                <div class="breadcrumb-item active">Surat {{ucwords($sifat_surat)}}</div>
            </div>
        </div>
                ...
                <div class="col-sm-12 order-sm-0 order-lg-0 order-xl-0">
                    <div class="card">
                        <div class="card-header">
                            <h4>Data Surat {{ucwords($sifat_surat)}}</h4>
                        ...
                        <div class="collapse" id="mycard-collapse">
                            <div class="card-body">
                                ...
                                @if($sifat_surat=='langsung')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row mb-3">
                                            <label class="col-sm-5 col-lg-5 col-form-label">Catatan Perjalanan
                                                Surat</label>
