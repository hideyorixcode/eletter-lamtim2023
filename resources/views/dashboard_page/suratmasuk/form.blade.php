...
@section('title', 'Form '.ucwords($mode).' Surat Masuk ')
@push('vendor-css')
...
<section class="section">
   <div class="section-header">
      <h1>{{'Form '.ucwords($mode).' Surat Masuk '}}</h1>
      <div class="section-header-breadcrumb">
         <div class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></div>
         <div class="breadcrumb-item"><a href="{{route('surat-masuk')}}">Daftar Surat Masuk</a></div>
         <div class="breadcrumb-item active">{{'Form '.ucwords($mode).' Surat Masuk '}}</div>
      </div>
   </div>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="col-sm-12">
                        ...
                        <div class="row mb-3">
                           <label class="col-sm-3 col-lg-3 col-form-label">Nomor Agenda</label>
                           <div class="col-sm-9 col-lg-9">
                              <div class="input-group">
                                 <span
                  ...
                  <div class="card-body">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 col-lg-9">
                           ...
                           <option
                           value={{$value}} {{$value==$tujuan ? 'selected' : ''}}>{{$nama}}</option>
                           @endforeach
                           </select>
                           @error('tujuan')
                           <div class="invalid-feedback">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 col-lg-9">
                           <input type="text" readonly value="BAGIAN PROTOKOL PIMPINAN" class="form-control">
                           @error('melalui')
                           <div class="invalid-feedback">
                              {{$message}}
                           </div>
