...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Daftar Surat Langsung</h1>
            @if(in_array(Auth::user()->level, ['superadmin', 'admin', 'adpim']))
                <div class="section-header-button">
                    <a href="{{ route('surat-langsung.form') }}"
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Daftar Surat Langsung</div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        Surat langsung adalah surat masuk yang tidak melalui biro umum namun langsung
                                        diserahkan kepada
                                        pejabat tinggi (Bupati, Wakil Bupati, Sekda, asisten) saat pengirim surat
                                        bertamu atau bertemu langsung dengan pimpinan.
                                    </div>
                                </div>
                                <div class="col-md-12">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteData(paramId) {
            var url = '{{ url('dashboard/surat-langsung/delete/') }}';
            deleteDataTable(paramId, url);
        }

        function bulkDelete() {
            var url = '{{ url('dashboard/surat-langsung/bulkDelete/') }}';
            bulkDeleteTable(url);
        }
