                           ...
                           <div class="col-sm-9 col-lg-9">
                              <div class="input-group">
                                 ...
                                 <input class="form-control @error('no_surat') is-invalid @enderror"
                                    ...
                                    type="text" disabled value="{{$no_surat}}">
                                  @error('no_surat')
                           ...
                           <div class="col-sm-9 col-lg-9">
                              <div class="input-group">
                                 ...
                                 <input class="form-control @error('tgl_surat') is-invalid @enderror"
                                    ...
                                    type="text" disabled value="{{$tgl_surat}}">
                                  @error('tgl_surat')
                                                                <div class="invalid-feedback">
                                                                   {{$message}}
                                                                </div>
                           ...
                           <div class="col-sm-9 col-lg-9">
                              <div class="input-group">
                                 ...
                                 <input class="form-control @error('lampiran') is-invalid @enderror"
                                    ...
                                    type="number" disabled value="{{$lampiran}}">
                                  @error('lampiran')
                                                               <div class="invalid-feedback">
                                                                  {{$message}}
                                                               </div>
                           ...
                           <div class="col-sm-9 col-lg-9">
                              <div class="input-group">
                                 ...
                                 <input class="form-control @error('perihal') is-invalid @enderror"
                                    ...
                                    type="text" disabled value="{{$perihal}}">
                                  @error('perihal')
                                                               <div class="invalid-feedback">
                                                                  {{$message}}
                                                               </div>
               ...
               <div class="card">
                  <div class="card-body">
                        ...
                        <div class="col-sm-9 col-lg-9">
                           <div class="input-group">
                              ...
                              <input class="form-control @error('kode') is-invalid @enderror"
                                 name="kode" id="kode"
                                 type="text" value="{{$kode}}" autofocus>
                               @error('kode')
                                                         <div class="invalid-feedback">
                                                            {{$message}}
                                                         </div>
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 col-lg-9">
                           <textarea class="form-control" name="catatan" id="catatan" style="min-height: 100px" disabled>{{$catatan}}</textarea>
                           @error('catatan')
                           <div class="invalid-feedback">
                              {{$message}}
                           </div>
