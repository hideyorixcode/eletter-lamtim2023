                                 ...
                                 <i class="fa fa-align-right"></i></label>
                                    ...
                                    @if($mode=='ubah')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            @else
                                                <label class="col-sm-9 col-lg-9 col-form-label text-warning">Belum
                                                    Diupload Bagian Umum</label>
                                            @endif
                            ...
                            <div class="card-body">
                              ...
                              <i class="fa fa-user"></i></label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 col-lg-9">
                                        <select class="select_cari form-control" id="melalui"
                                                name="melalui"  @if($mode=='ubah') disabled @endif>
                                            @foreach($listMelalui as $nama => $value)
                                                <option
                                                    value={{$value}} {{$value==$melalui ? 'selected' : ''}}>{{$nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('melalui')
                                        <div class="invalid-feedback">
