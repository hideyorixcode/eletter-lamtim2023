...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Dashboard Biro</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="javascript:void(0)">Dashboard Biro</a></div>
            </div>
        </div>
                                    ...
                                    <div class="tickets-list overflow-auto" style="height:300px">
                                        @if(count($listSMbiasa)>0)
                                            @foreach($listSMbiasa as $biasa)
                                                <a href="{{url('dashboard/disposisi/'.Vinkla\Hashids\Facades\Hashids::encode($biasa->id))}}"
                                                   class="ticket-item">
                                                    ...
                                                    <div class="ticket-info">
                                                        ...
                                                        <div
                                                            class="text-primary">{{TanggalIndo2($biasa->tgl_surat)}}</div>
                                                    </div>
                                                </a>
                                            @endforeach
                                        @endif
                                    ...
                                    <div class="tickets-list overflow-auto" style="height:300px">
                                        @if(count($listSK)>0)
                                            @foreach($listSK as $keluar)
                                                <a href="{{url('surat-keluar/'.Vinkla\Hashids\Facades\Hashids::encode($keluar->id))}}"
                                                   target="_blank" class="ticket-item">
                                                    <div class="ticket-title">
                                                    ...
                                                    <div class="ticket-info">
                                                        ...
                                                        <div class="bullet"></div>
                                                        <div
                                                            class="text-primary">{{TanggalIndo2($keluar->tgl_surat)}}</div>
                                                    </div>
                                                </a>
                                            @endforeach
                                        @endif
